            ...
            <div class="col-9">
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        ...
                        <div>
                            <a href="member-tambah.html" class="btn btn-dark">Tambah</a>
                        </div>
                    </div>
                    <div class="card-body">
                        <!-- data table -->
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>I am a teacher of Math. I love teaching people and doing competitive
                                        programming.</td>
                                    <td>
                                        <a href="member-detail.html" class="btn btn-sm btn-dark bg-light text-dark">Detail</a>
                                        <a href="member-ubah.html" class="btn btn-sm btn-success bg-light text-success">Ubah</a>
                                        <a href="#modal-hapus-1" class="btn btn-sm btn-danger bg-light text-danger">Hapus</a>
                                    </td>
                                </tr>
                                <tr>
                                    <th scope="row">2</th>
